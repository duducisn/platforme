...
<!-- Sidebar -->
<div class="sidebar">
    <h4 class="text-light">Espace étudiant</h4>
    <p class="mt-4 text-light">Connecté : <strong><?php echo $_SESSION['login']; ?></strong></p>

    <a href="espace_etudiant.php" class="sidebar-link">Accueil</a>

    <div class="dropdown">
        <a class="btn btn-dark dropdown-toggle w-100 text-start sidebar-link" href="#" role="button" id="dropdownNotes" data-bs-toggle="dropdown" aria-expanded="false">
            Mes notes
        </a>
        <ul class="dropdown-menu w-100" aria-labelledby="dropdownNotes">
            <li><a class="dropdown-item sidebar-dropdown-item" href="voir_toutes_les_notes_etudiant.php">Voir toutes mes notes</a></li>
>
        </ul>
    </div>
...
<div class="main-content">
    <h3 class="mb-4">Mon espace étudiant</h3>

    <h5>Mes informations administratives</h5>
    <table class="table table-bordered mt-3">
        <tr><th>Matricule</th><td><?php echo $etudiant['ine']; ?></td></tr>
        <tr><th>Nom</th><td><?php echo $etudiant['nom']; ?></td></tr>
        <tr><th>Prénom</th><td><?php echo $etudiant['prenom']; ?></td></tr>
        <tr><th>Email</th><td><?php echo $etudiant['email']; ?></td></tr>
        <tr><th>Téléphone</th><td><?php echo $etudiant['telephone']; ?></td></tr>
        <tr><th>Sexe</th><td><?php echo $etudiant['sexe']; ?></td></tr>
        <tr><th>Filière</th><td><?php echo $etudiant['filiere']; ?></td></tr>
        <tr><th>Lieu de naissance</th><td><?php echo $etudiant['eno']; ?></td></tr>
    </table>
